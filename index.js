...
/////////////////
const BotName = 'FIRO BOT☄'; 
const instagram = 'https://instagram.com/lynuxxteam'; 
const telegram = 'Belum Ada'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtube.com/channel/UCbI_XbfyiVJH1706i3mRZoA';
//const grupch1 = 'https://chat.whatsapp.com/CmbHbTodjd1FPmGgTJpnDB'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@lynuxxteam')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@lynuxxteam`)
})
